                ...
                {metrics &&
                    <div >
                        <div className={classes.talkingStats}>
                            <h5>Silence Time</h5>
                            <CircularProgress variant="determinate" value={metrics[0].percent} />
                        ...
                        <div className={classes.talkingStats}>
                            <h5>Talking time</h5>
                            <CircularProgress variant="determinate" value={metrics[1].percent} />
                    ...
                    <div>
                        <ul>
                            {membersInfo.map(member => (
                                <li key={member.id} >
                                    <h3>{member.name} talked for {member.talkTime.seconds} seconds</h3>
                                    <LinearProgressWithLabel variant="determinate" value={member.talkTime.percentage} />
                                </li>
                            ))}
                        </ul>
                    </div>
